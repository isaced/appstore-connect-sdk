...
export class BetaTestersApi extends runtime.BaseAPI {
    ...
    /**
     */
    async betaTestersAppsGetToManyRelatedRaw(requestParameters: BetaTestersAppsGetToManyRelatedRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AppsResponse>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
    ...
    /**
     */
    async betaTestersAppsGetToManyRelated(requestParameters: BetaTestersAppsGetToManyRelatedRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AppsResponse> {
    ...
    /**
     */
    async betaTestersBetaGroupsGetToManyRelatedRaw(requestParameters: BetaTestersBetaGroupsGetToManyRelatedRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<BetaGroupsResponse>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
    ...
    /**
     */
    async betaTestersBetaGroupsGetToManyRelated(requestParameters: BetaTestersBetaGroupsGetToManyRelatedRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<BetaGroupsResponse> {
    ...
    /**
     */
    async betaTestersBuildsGetToManyRelatedRaw(requestParameters: BetaTestersBuildsGetToManyRelatedRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<BuildsResponse>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
    ...
    /**
     */
    async betaTestersBuildsGetToManyRelated(requestParameters: BetaTestersBuildsGetToManyRelatedRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<BuildsResponse> {
