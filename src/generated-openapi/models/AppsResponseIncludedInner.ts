...
export function AppsResponseIncludedInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): AppsResponseIncludedInner {
    ...
    return { ...AppClipFromJSONTyped(json, true), ...AppCustomProductPageFromJSONTyped(json, true), ...AppEventFromJSONTyped(json, true), ...AppInfoFromJSONTyped(json, true), ...AppPreOrderFromJSONTyped(json, true), ...AppPriceFromJSONTyped(json, true), ...AppStoreVersionFromJSONTyped(json, true), ...BetaAppLocalizationFromJSONTyped(json, true), ...BetaAppReviewDetailFromJSONTyped(json, true), ...BetaGroupFromJSONTyped(json, true), ...BetaLicenseAgreementFromJSONTyped(json, true), ...BuildFromJSONTyped(json, true), ...CiProductFromJSONTyped(json, true), ...EndUserLicenseAgreementFromJSONTyped(json, true), ...GameCenterEnabledVersionFromJSONTyped(json, true), ...InAppPurchaseFromJSONTyped(json, true), ...InAppPurchaseV2FromJSONTyped(json, true), ...PrereleaseVersionFromJSONTyped(json, true), ...PromotedPurchaseFromJSONTyped(json, true), ...ReviewSubmissionFromJSONTyped(json, true), ...SubscriptionGracePeriodFromJSONTyped(json, true), ...SubscriptionGroupFromJSONTyped(json, true), ...TerritoryFromJSONTyped(json, true) };
}
...
export function AppsResponseIncludedInnerToJSON(value?: AppsResponseIncludedInner | null): any {
    ...
    if (instanceOfAppPrice(value)) {
        return AppPriceToJSON(value as AppPrice);
    }
