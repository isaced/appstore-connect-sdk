 ...
 */
export function instanceOfAppScreenshotSetsResponse(value: object): boolean {
    let isInstance = true;
...
export function AppScreenshotSetsResponseToJSON(value?: AppScreenshotSetsResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
