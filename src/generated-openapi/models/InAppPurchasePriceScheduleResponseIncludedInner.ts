 ...
 * @export
 */
export type InAppPurchasePriceScheduleResponseIncludedInner = InAppPurchasePrice | InAppPurchaseV2;
...
export function InAppPurchasePriceScheduleResponseIncludedInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): InAppPurchasePriceScheduleResponseIncludedInner {
    ...
    return { ...InAppPurchasePriceFromJSONTyped(json, true), ...InAppPurchaseV2FromJSONTyped(json, true) };
}
