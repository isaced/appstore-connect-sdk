 ...
 */
export function instanceOfAppStoreReviewDetailCreateRequest(value: object): boolean {
    let isInstance = true;
...
export function AppStoreReviewDetailCreateRequestToJSON(value?: AppStoreReviewDetailCreateRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
