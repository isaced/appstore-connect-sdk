...
export function AppStoreVersionsResponseIncludedInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): AppStoreVersionsResponseIncludedInner {
    ...
    return { ...AgeRatingDeclarationFromJSONTyped(json, true), ...AlternativeDistributionPackageFromJSONTyped(json, true), ...AppFromJSONTyped(json, true), ...AppClipDefaultExperienceFromJSONTyped(json, true), ...AppStoreReviewDetailFromJSONTyped(json, true), ...AppStoreVersionExperimentFromJSONTyped(json, true), ...AppStoreVersionExperimentV2FromJSONTyped(json, true), ...AppStoreVersionLocalizationFromJSONTyped(json, true), ...AppStoreVersionPhasedReleaseFromJSONTyped(json, true), ...AppStoreVersionSubmissionFromJSONTyped(json, true), ...BuildFromJSONTyped(json, true), ...RoutingAppCoverageFromJSONTyped(json, true) };
}
