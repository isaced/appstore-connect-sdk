 ...
 */
export function instanceOfSubscriptionRelationshipsPromotionalOffers(value: object): boolean {
    let isInstance = true;
...
export function SubscriptionRelationshipsPromotionalOffersToJSON(value?: SubscriptionRelationshipsPromotionalOffers | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
