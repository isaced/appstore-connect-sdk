 ...
 */
export function instanceOfGameCenterMatchmakingRuleSetTestResponse(value: object): boolean {
    let isInstance = true;
...
export function GameCenterMatchmakingRuleSetTestResponseToJSON(value?: GameCenterMatchmakingRuleSetTestResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
