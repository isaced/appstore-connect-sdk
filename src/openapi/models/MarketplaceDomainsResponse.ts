 ...
 */
export function instanceOfMarketplaceDomainsResponse(value: object): boolean {
    let isInstance = true;
...
export function MarketplaceDomainsResponseToJSON(value?: MarketplaceDomainsResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
