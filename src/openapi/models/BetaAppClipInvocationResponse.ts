 ...
 */
export function instanceOfBetaAppClipInvocationResponse(value: object): boolean {
    let isInstance = true;
...
export function BetaAppClipInvocationResponseToJSON(value?: BetaAppClipInvocationResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
