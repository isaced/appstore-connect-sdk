...
export class ProfilesApi extends runtime.BaseAPI {
    ...
    /**
     */
    async profilesBundleIdGetToOneRelatedRaw(requestParameters: ProfilesBundleIdGetToOneRelatedRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<BundleIdResponse>> {
    ...
    /**
     */
    async profilesBundleIdGetToOneRelated(requestParameters: ProfilesBundleIdGetToOneRelatedRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<BundleIdResponse> {
    ...
    /**
     */
    async profilesCertificatesGetToManyRelatedRaw(requestParameters: ProfilesCertificatesGetToManyRelatedRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CertificatesResponse>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
    ...
    /**
     */
    async profilesCertificatesGetToManyRelated(requestParameters: ProfilesCertificatesGetToManyRelatedRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CertificatesResponse> {
    ...
    /**
     */
    async profilesDevicesGetToManyRelatedRaw(requestParameters: ProfilesDevicesGetToManyRelatedRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DevicesResponse>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
    ...
    /**
     */
    async profilesDevicesGetToManyRelated(requestParameters: ProfilesDevicesGetToManyRelatedRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DevicesResponse> {
