...
import AppStoreConnectAPI from "https://esm.sh/appstore-connect-sdk@1.0.0-beta.0";
import { AppsApi } from "https://esm.sh/appstore-connect-sdk@1.0.0-beta.0/dist/openapi/apis/index.js";
...
const res = await (await client.call(AppsApi)).appsGetCollection();
console.log(res);
